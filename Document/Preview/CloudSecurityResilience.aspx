<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CloudSecurityResilience.aspx.cs" Inherits="UsersWebApplication1.Document.Preview.CloudSecurityResilience" %>
...
<body style="margin:0;">
    <form id="form1" runat="server">
        <div class="container">
            ...
            <img runat="server" id="imgSlide10" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide11" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide12" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide13" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide14" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide15" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide16" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide17" width="1370" style="vertical-align:bottom"/>
            <img runat="server" id="imgSlide18" width="1370" style="vertical-align:bottom" />
