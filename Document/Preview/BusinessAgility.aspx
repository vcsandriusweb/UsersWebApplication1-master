<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessAgility.aspx.cs" Inherits="UsersWebApplication1.Document.Preview.BusinessAgility" %>
...
<body style="margin:0;">
    <form id="form1" runat="server">
        <div class="container">
            <img runat="server" id="imgSlide1" width="1370" style="vertical-align:bottom"/><br />
            <img runat="server" id="imgSlide2" width="1370" style="vertical-align:bottom"/><br />
            <img runat="server" id="imgSlide3" width="1370" style="vertical-align:bottom"/><br />
            <img runat="server" id="imgSlide4" width="1370" style="vertical-align:bottom"/><br />
            <img runat="server" id="imgSlide5" width="1370" style="vertical-align:bottom"/><br />
            <img runat="server" id="imgSlide6" width="1370" style="vertical-align:bottom"/><br />
