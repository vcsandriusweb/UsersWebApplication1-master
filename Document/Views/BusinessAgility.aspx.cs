...
{
    public partial class BusinessAgility : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (documentTable.Rows.Count > 0)
                {
                    ...
                    imgSlide2.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/BusinessAgility/Slide2.PNG";
                    imgSlide3.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/BusinessAgility/Slide3.PNG";
                    imgSlide4.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/BusinessAgility/Slide4.PNG";
                    imgSlide5.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/BusinessAgility/Slide5.PNG";
                    imgSlide6.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/BusinessAgility/Slide6.PNG";
                }
            }
