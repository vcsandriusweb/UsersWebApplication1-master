...
{
    public partial class DigitalTransformation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (documentTable.Rows.Count > 0)
                {
                    ...
                    imgSlide2.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/DigitalTransformation/Slide2.PNG";
                    imgSlide3.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/DigitalTransformation/Slide3.PNG";
                    imgSlide4.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/DigitalTransformation/Slide4.PNG";
                    imgSlide5.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/DigitalTransformation/Slide5.PNG";
                    imgSlide6.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/DigitalTransformation/Slide6.PNG";
                    imgSlide7.Src = ConfigurationManager.AppSettings["Host"].ToString() + "Images/DigitalTransformation/Slide7.PNG";
