<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmailWorkflow4.aspx.cs" Inherits="UsersWebApplication1.Email.EmailWorkflow4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container workflow-content">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div style="margin-left: 950px;">
                        <asp:HyperLink runat="server" ID="HyperLink1" Style="font-size: 14px" class="btn btn-outline-danger btn-sm" NavigateUrl="~/Email/EmailWorkflow3.aspx">< Back</asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-2 user-input">
            <div class="row">
                <div class="col-6">
                    <span class="col-form-label-sm" style="font-size: 12px">1. Custom greeting header</span>
                    <br />
                    <asp:TextBox ID="txtCustomGreetingHeader" Columns="40" runat="server" TextMode="MultiLine" Rows="3"
                        MaxLength="240" onkeyup="LimitCharacters(this,240,'lblCustomGreetingHeader');">
                    </asp:TextBox><br />
                    <span class="col-form-label-sm" style="font-size: 10px">
                        <label id="lblCustomGreetingHeader">240</label>&nbsp;characters left
                    </span>
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <span class="col-form-label-sm" style="font-size: 12px">2. Custom greeting text</span>
                    <br />
                    <asp:TextBox ID="txtCustomGreetingText" runat="server" Columns="40" TextMode="MultiLine" Rows="4"
                        MaxLength="240" onkeyup="LimitCharacters(this,240,'lblCustomGreetingText');">
                    </asp:TextBox><br />
                    <span class="col-form-label-sm" style="font-size: 10px">
                        <label id="lblCustomGreetingText">240</label>&nbsp;characters left
                    </span>
                </div>
                <div class="col-6">
                    <%--TODO--%>
            ...
            <div class="row">
                <div class="col-6">
                    <span class="col-form-label-sm" style="font-size: 12px">3. Custom close text</span>
                    <br />
                    <asp:TextBox ID="txtCustomCloseText" runat="server" Columns="40" TextMode="MultiLine" Rows="10"
                        MaxLength="600" onkeyup="LimitCharacters(this,600,'lblCustomCloseText');">
                    </asp:TextBox><br />
                    <span class="col-form-label-sm" style="font-size: 10px">
                        <label id="lblCustomCloseText">600</label>&nbsp;characters left
                    </span>
                </div>
                <div class="col-6">
                    <span class="col-form-label-sm" style="font-size: 12px">Example cover</span>
        ...
        <div class="container">
            <div class="row align-items-start">
                <div class="col-sm-2">
                    <asp:HyperLink runat="server" ID="BackHyperLink" Style="font-size: 14px" class="btn btn-outline-danger btn-sm" NavigateUrl="~/Email/EmailWorkflow3.aspx">< Back</asp:HyperLink>
                </div>
                <div class="col-sm">
